...
Route::put('/comics/{comic}', [ComicsController::class, 'update'])->name('guest.comics.update');
Route::get('/comics/{comic}/edit', [ComicsController::class, 'edit'])->name('guest.comics.edit');